...
QnnModel_GenAI_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  VALIDATE(qnn_model.addTensor("x0",  // Node Name
                               (Qnn_Tensor_t)tin),
           err);
  ...
  VALIDATE(qnn_model.addTensor("x1",  // Node Name
                               (Qnn_Tensor_t)tin2),
           err);
  ...
  VALIDATE(qnn_model.addTensor("x2",  // Node Name
                               (Qnn_Tensor_t)tin3),
           err);
  ...
  VALIDATE(qnn_model.addTensor("x3",  // Node Name
                               (Qnn_Tensor_t)tin4),
           err);
  ...
  VALIDATE(qnn_model.addTensor("x4",  // Node Name
                               (Qnn_Tensor_t)tin5),
           err);
  ...
  VALIDATE(qnn_model.addTensor("x5",  // Node Name
                               (Qnn_Tensor_t)tin6),
           err);
  ...
  VALIDATE(qnn_model.addTensor("x6",  // Node Name
                               (Qnn_Tensor_t)tin7),
           err);
  ...
  VALIDATE(qnn_model.addTensor("x7",  // Node Name
                               (Qnn_Tensor_t)tin8),
           err);
  ...
  VALIDATE(qnn_model.addTensor("x8",  // Node Name
                               (Qnn_Tensor_t)tin9),
           err);
