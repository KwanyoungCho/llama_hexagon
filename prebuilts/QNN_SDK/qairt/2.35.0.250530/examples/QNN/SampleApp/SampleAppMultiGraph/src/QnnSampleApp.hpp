...
class QnnSampleApp {
 ...
 private:
  ...
  StatusCode executeGraph(size_t graphIdx,
  ...
  uint64_t m_memLimitHint;
  std::vector<std::string> m_executionOrder;
  std::string m_currentlyLoadedGraph = "";
  QnnContext_Config_t m_memLimitHintCfg;
  QnnContext_Config_t m_persistentBinCfg;
