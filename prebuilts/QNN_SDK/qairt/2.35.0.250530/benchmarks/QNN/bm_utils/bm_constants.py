...
class BmConstants:
    ...
    CONFIG_DEVICEOSTYPES_WINDOWS_ARM64X = 'arm64x-windows-msvc'
    ...
    def __init__(self):
        ...
        self.BENCH_WINDOWS_ARM64X_ARTIFACTS_JSON = "qnnbm_artifacts_aarch64-windows-msvc.json"
