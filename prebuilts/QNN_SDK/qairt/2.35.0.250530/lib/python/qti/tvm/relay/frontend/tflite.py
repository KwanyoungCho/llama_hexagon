...
class OperatorConverter(object):
    ...
    ### [End QTI Change]
        ...
        ### [End QTI Change]
            ...
            if op_code_str == "CUSTOM" or op_code_str in custom_op_factory.op_collection:
                ...
                ret = ret[0] if len(output_tensors) == 1 else ret
    ...
    def get_op_code_str(self, op):
        ...
        if op_code_id == BuiltinOperator.CUSTOM:
            ...
            if custom_op_code_str == b"FlexMul":
                return "FlexMul"
            if custom_op_code_str == b"CUSTOM" or custom_op_code_str == "CUSTOM":
                logger.warning("The operation type ‘CUSTOM’ is unexpected after extraction of CustomCode"
                               "Please ensure that the Custom Op Type specified in the Custom Op XML aligns with the kernel;"
                               "otherwise, the conversion process will fail.")
            return custom_op_code_str.decode('ascii')
            ### [End QTI Change]
    ...
    def convert_custom(self, op, node_name, custom_ops_dict):
        from qti.aisw.converters.qnn_backend.custom_ops.core import qnn_to_dtype
        ...
        def custom_op_rel(arg_types, attrs):
            ...
            output_type = [tvm.relay.TensorType(output_dim, qnn_to_dtype(output.data_type))
