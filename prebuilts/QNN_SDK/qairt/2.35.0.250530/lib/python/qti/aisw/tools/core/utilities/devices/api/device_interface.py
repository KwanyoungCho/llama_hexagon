...
# ==============================================================================
import logging
from typing import List, Union, Iterable, Optional, TypeVar
...
class DeviceInterface(ABC):
    ...
    def __init__(self, device_info: Optional[DeviceInfoType] = None, logger: Optional[logging.Logger] = None):
        """
    ...
    @property
    def device_info(self) -> DeviceInfoType:
        """
    ...
    def get_device_log(self, **kwargs) -> Union[AnyStr, None]:
        ...
        """
        raise NotImplementedError("The method: get_device_log has not been implemented for this "
                                  "class")
