...
converter_op_support = {
    ...
    "QNN_OP_BATCH_TO_SPACE": {TENSORFLOW: "batch_to_space", TENSORFLOW_LITE: "batch_to_space_nd"},
    ...
    "QNN_OP_CONV_2D": {ONNX: "Conv, QLinearConv", TENSORFLOW: "conv2d", TENSORFLOW_LITE: "conv_2d", PYTORCH: "Conv2d"},
    "QNN_OP_CONV_3D": {ONNX: "Conv, QLinearConv", TENSORFLOW: "conv3d"},
    "QNN_OP_CONSTANT_OF_SHAPE": {ONNX: "ConstantOfShape"},
    ...
    "QNN_OP_DEPTH_WISE_CONV_2D": {ONNX: "Conv with 'num_output' == 'input channels' == 'group',"
                                  "QLinearConv with 'num_output' == 'input channels' == 'group'",
    ...
    "QNN_OP_TRANSPOSE_CONV_3D": {ONNX: "ConvTranspose", TENSORFLOW: "conv3d_transpose"},
    ...
    "QNN_OP_ELEMENT_WISE_NOT_EQUAL": {ONNX: "IsNaN", TENSORFLOW: "not_equal", PYTORCH: "ne"},
    ...
    "QNN_OP_ELEMENT_WISE_SELECT": {ONNX: "Where", TENSORFLOW: "where"},
    ...
    "QNN_OP_GELU": {ONNX: MATCHED+" / Gelu(for onnx version>=1.15)", TENSORFLOW: MATCHED, PYTORCH: "GELU"},
    ...
    "QNN_OP_GROUP_NORM": {ONNX: "GroupNormalization", PYTORCH: "GroupNorm"},
    "QNN_OP_GRU": {ONNX: "GRU"},
    ...
    "QNN_OP_IS_INF": {ONNX: "IsInf"},
    "QNN_OP_L2_NORM": {ONNX: "LpNormalization", TENSORFLOW: MATCHED},
    "QNN_OP_LAYER_NORM": {ONNX: "LayerNormalization", TENSORFLOW: "LayerNormalization", PYTORCH: "LayerNorm"},
    ...
    "QNN_OP_MAT_MUL": {ONNX: "MatMul, QLinearMatMul", TENSORFLOW: "matmul(BatchMatMul, BatchMatMulV2)", PYTORCH: "matmul"},
    ...
    "QNN_OP_REDUCE_SUM_SQUARE": {ONNX: "ReduceSumSquare"},
    ...
    "QNN_OP_SHAPE": {ONNX: "Shape"},
    "QNN_OP_SIGMOID": {ONNX: "Sigmoid", TENSORFLOW: "sigmoid", PYTORCH: "sigmoid"},
    "QNN_OP_SPACE_TO_BATCH": {TENSORFLOW: "space_to_batch(SpaceToBatchND)", TENSORFLOW_LITE: "space_to_batch_nd"},
